...
class NoDayTradesAlgorithm(Algorithm):
    ...
    def __init__(self, query, sec_interval = 900):
        ...
        # Call super.__init__
        Algorithm.__init__(self, query, sec_interval, name = "NoDayTradesAlgorithm")
    ...
    def weights_trading_algorithm(self):
        ...
        # Store the quantities of each stock owned, as well as the symbol into a list of all symbols
